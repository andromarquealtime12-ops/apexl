    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex flex-col items-center gap-6 py-4">
          <img src="/icons/icon-192x192.png" alt="APEXL" className="w-24 h-24 rounded-2xl shadow-lg" />

          {installed ? (
            <div className="text-center space-y-2">
              <div className="text-4xl">✅</div>
              <p className="text-lg font-semibold text-foreground">Application installée !</p>
              <p className="text-sm text-muted-foreground">Retrouvez APEXL sur votre écran d'accueil.</p>
            </div>
          ) : ready ? (
                  ...
                  <>
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/50">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Menu ⋮ → <strong>"Installer APEXL"</strong>
                        </p>
                      </div>
                    </div>
                  </>
