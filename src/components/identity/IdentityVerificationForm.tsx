 ...
 import { Shield, Upload, Camera, CheckCircle, Clock, XCircle, AlertTriangle } from "lucide-react";
 ...
 export default function IdentityVerificationForm() {
   ...
   const submitVerification = useMutation({
     ...
     onSuccess: () => {
       toast({ title: "Demande envoyée ✓", description: "Votre demande sera examinée sous 24-48h." });
