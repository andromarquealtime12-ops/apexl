      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-3xl mx-auto prose prose-sm text-muted-foreground space-y-6">
          ...
          <section className="space-y-3">
            ...
            <p>Nous collectons les données suivantes lors de votre utilisation d'Ayiti Market :</p>
          ...
          <section className="space-y-3">
            ...
            <p>Ayiti Market utilise des cookies essentiels pour le fonctionnement de la plateforme (session, authentification). Aucun cookie publicitaire n'est utilisé.</p>
          </section>

          <section className="space-y-3">
            <h2 className="text-xl font-semibold text-foreground">8. Contact</h2>
            <p>Pour toute question relative à la protection de vos données, contactez-nous à contact@ayitimarket.com ou au +1 (829) 699-9294.</p>
          </section>
        </div>
      </div>
      <Footer />
