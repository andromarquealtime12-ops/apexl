      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-3xl mx-auto prose prose-sm text-muted-foreground space-y-6">
          ...
          <section className="space-y-3">
            ...
            <p>
              L'ensemble du contenu du site APEXL (textes, images, logos, graphismes, 
          ...
          <section className="space-y-3">
            ...
            <p>
              APEXL s'efforce d'assurer l'exactitude des informations diffusées sur 
              le site. Toutefois, elle ne peut garantir l'exactitude, la complétude et 
              l'actualité des informations. APEXL agit en tant qu'intermédiaire entre 
