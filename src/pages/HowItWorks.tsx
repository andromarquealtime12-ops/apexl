...
const HowItWorks = () => {
  const steps = [
    ...
    { icon: CreditCard, title: "3. Payez en toute sécurité", desc: "Payez via votre portefeuille APEXL. Rechargez-le via transfert bancaire ou agent de dépôt." },
    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <p className="text-muted-foreground text-center mb-12 max-w-2xl mx-auto">
          APEXL rend l'achat en ligne simple et sécurisé. Voici comment ça fonctionne en 6 étapes.
        </p>
